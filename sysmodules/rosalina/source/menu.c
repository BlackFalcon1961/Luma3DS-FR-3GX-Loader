...
static void menuDraw(Menu *menu, u32 selected)
{
    ...
    if(isRelease)
        Draw_DrawFormattedString(10, SCREEN_BOT_HEIGHT - 20, COLOR_TITLE, "Luma3DS-FR %s", versionString);
    else
        Draw_DrawFormattedString(10, SCREEN_BOT_HEIGHT - 20, COLOR_TITLE, "Luma3DS-FR %s-%08lx", versionString, commitHash);
