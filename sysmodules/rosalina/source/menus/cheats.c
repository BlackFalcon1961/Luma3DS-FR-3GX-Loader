...
void RosalinaMenu_Cheats(void)
{
    ...
    if (titleId == 0 || cheatCount == 0)
    {
        ...
        {
            Draw_Lock();
            Draw_DrawString(10, 10, COLOR_TITLE, "Triche");
            if (titleId == 0)
            {
                Draw_DrawString(10, 30, COLOR_WHITE, "Aucun titre approprie trouve");
            }
            else
            {
                Draw_DrawFormattedString(10, 30, COLOR_WHITE, "Aucune triche trouvee pour le titre %016llX", titleId);
            }
