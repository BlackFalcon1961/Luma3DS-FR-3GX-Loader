...
static size_t saveLumaIniConfigToStr(char *out)
{
    ...
    if (VERSION_BUILD != 0) {
        sprintf(lumaVerStr, "Luma3DS-FR v%d.%d.%d", (int)VERSION_MAJOR, (int)VERSION_MINOR, (int)VERSION_BUILD);
    } else {
        sprintf(lumaVerStr, "Luma3DS-FR v%d.%d", (int)VERSION_MAJOR, (int)VERSION_MINOR);
    }
